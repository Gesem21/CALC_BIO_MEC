...
from PIL import Image, ImageTk #Importamos la libreria pillow
...
class Application:
    ...
    def iniciar_interfaz(self): #Funcion de pantalla 1 (Bienvenida)
        #Habilitamos la imagen de fondo (home.png)
        img0_original = Image.open("home.png")  # Carga la imagen original.
        img0_resized = img0_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen a la ventana.
        img0 = ImageTk.PhotoImage(img0_resized)
        self.label0 = tk.Label(self.ventana, image=img0) #Label de home.png 
        self.label0.image=img0
        self.label0.place(x=0, y=0)
        #Primer boton de iniciar
    ...
    def destruir(self): #Esta funcion destruye la ventana
        self.ventana.destroy()
        

    def anuncio(self): #Esta funcion muesta la advertencia antes de empezar
        #Cargamos la imagen advertencia.png de fondo
        img00_original = Image.open("advertencia.png")  # Carga la imagen original.
        img00_resized = img00_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen a la ventana.
    ...
    def service(self): #Esta funcion muestra la imagen de presentacion
        #Pantalla de servicios que presenta la interfaz
        img69_original = Image.open("services.png")  # Carga la imagen original.
        img69_resized = img69_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen a la ventana.
    ...
    def entradas(self): #Funcion para que ingresen los datos
        #Pantalla de entradas personales.png
        img2_original = Image.open("personales.png")  # Carga la imagen original.
        img2_resized = img2_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen a la ventana.
        img2 = ImageTk.PhotoImage(img2_resized)
        #Cargamos la imagen personales.png a un label
    ...
    def validacion(self): #Funcion para validar los datos a csv y los parametros saludables
        #Este apartado se guardaran y enviaran los datos introducidos a un archivo csv
        try:
    ...
    def mostrar_alerta_imc(self): #Funcion de alerte de imc no saludable
    ...
    def medicamentos(self): #Funcion donde muestran los medicamentos listos para ser recetados
        #Cargamos fondo medicamentos.png
    ...
    def paracetamol(self): #Funcion para mostrar dosis de paracetamol
        #Cargar fondo
        ...
        #Boton de cerrar
        self.botont1 = tk.Button(ventana, text="Terminar", command=self.iniciar_interfaz)
    ...
    def ibuprofeno(self):#Funcion para mostrar dosis de ibuprofeno
        #Cargar fondo
        fondo11_original = Image.open("dosisfondo.png")  # Carga la imagen original.
        fondo11_resized = fondo11_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen al botón.
        fondo11 = ImageTk.PhotoImage(fondo11_resized)
        ...
        self.label_dosis1.place(relx=0.33, rely=0.5)
        #Cerrar
        self.botont2 = tk.Button(ventana, text="Terminar", command=self.iniciar_interfaz)
    ...
    def ceritizina(self):#Funcion para mostrar dosis de cetirizina
        #Cargar fondo
        fondo11_original = Image.open("dosisfondo.png")  # Carga la imagen original.
        fondo11_resized = fondo11_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen al botón.
        fondo11 = ImageTk.PhotoImage(fondo11_resized)
        ...
        self.label_dosis1.place(relx=0.33, rely=0.5)
        #Cerrar
        self.botont3 = tk.Button(ventana, text="Terminar", command=self.iniciar_interfaz)
    ...
    def loratadina(self): #Funcion para mostrar dosis de loratadina
        #Cargar fondo
        fondo11_original = Image.open("dosisfondo.png")  # Carga la imagen original.
        fondo11_resized = fondo11_original.resize((1534, 862), Image.Resampling.LANCZOS)  # Ajusta el tamaño de la imagen al botón.
        fondo11 = ImageTk.PhotoImage(fondo11_resized)
        ...
        self.label_dosis1.place(relx=0.33, rely=0.5)
        #Cerrar
        self.botont4 = tk.Button(ventana, text="Terminar", command=self.iniciar_interfaz)
